...
>
    <template x-if="!supported">
        <laraliveui:text>{{ __('Passkeys are not supported in this browser.') }}</laraliveui:text>
    </template>
    ...
    <template x-if="supported && showForm">
        <div class="space-y-4 rounded-lg border border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-800/50 p-4">
            ...
            />
            <laraliveui:text class="!mt-1">{{ __('Give this passkey a name to help you identify it later.') }}</laraliveui:text>
